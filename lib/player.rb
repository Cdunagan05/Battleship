...
class Player
  ...
  def gets_player_two_unit_ship
    loop do
      ...
      return two_ship if valid_ship(two_ship[0]) && valid_two_unit_ship_placement?(two_ship[0], two_ship[1]) && two_ship.length == 2
  ...
  def gets_player_three_unit_ship
    loop do
      ...
      return three_ship if valid_ship(three_ship[0]) && valid_three_unit_ship_placement?(three_ship[0], three_ship[2]) && three_ship.length == 3
      puts Messages.invalid_ship_placement_message
    end
  end
